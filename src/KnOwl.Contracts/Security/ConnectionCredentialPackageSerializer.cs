...
/// <summary>
/// Serializes and parses portable Control Plane/Runtime connection credential packages.
/// </summary>
public sealed class ConnectionCredentialPackageSerializer
{
    ...
    public ConnectionCredentialPackage Parse(string value)
    {
        ...
        return JsonSerializer.Deserialize<ConnectionCredentialPackage>(json, jsonOptions)
