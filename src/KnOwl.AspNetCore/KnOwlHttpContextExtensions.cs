...
/// <summary>
/// Provides helpers for opening KnOwl contexts from ASP.NET Core endpoints.
/// </summary>
public static class KnOwlHttpContextExtensions
{
    /// <summary>
    ...
    public static ValueTask<InboxOpenResult> OpenKnOwlAsync<TPayload>(
