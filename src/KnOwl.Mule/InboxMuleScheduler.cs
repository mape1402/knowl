...
public sealed class InboxMuleScheduler : IInboxMuleScheduler
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        return _mule.EnqueueAsync(key, payload, options =>
        {
            ...
            options.Metadata[KnOwlMuleMetadata.InboxEntryId] = context.Entry.Id.ToString();
            options.Metadata[KnOwlMuleMetadata.IdempotencyKey] = context.EffectiveIdempotencyKey;
