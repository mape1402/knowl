...
/// <summary>
/// Configures how Pigeon consume contexts are mapped to KnOwl message contexts.
/// </summary>
public sealed class KnOwlPigeonOptions
{
    /// <summary>
    ...
    /// <summary>
    /// Gets or sets whether Pigeon publish operations should be persisted through KnOwl outbox.
    /// </summary>
    public bool EnableOutbox { get; set; }

    /// <summary>
    /// Gets or sets an optional predicate used to decide whether a publish operation should use KnOwl outbox.
    /// </summary>
    ...
    /// <summary>
    /// Gets or sets the decision returned when KnOwl rejects a consumed message.
    /// </summary>
