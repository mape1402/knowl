...
public sealed class DefaultInboxPayloadFingerprinter : IInboxPayloadFingerprinter
{
    ...
    /// </summary>
    /// <param name="options">The KnOwl options containing profile discovery assemblies.</param>
    public DefaultInboxPayloadFingerprinter(IOptions<KnOwlOptions> options)
    {
    ...
    private static IReadOnlyDictionary<Type, Func<object, object>> Discover(KnOwlOptions options)
    {
