...
/// <summary>
/// Executes declared KnOwl operations through the inbox lifecycle.
/// </summary>
public interface IKnOwlOperationService
{
    /// <summary>
    ...
    ValueTask<KnOwlOperationResult<TResult>> ExecuteAsync<TOperation, TRequest, TResult>(
        TRequest request,
    ...
    /// <param name="cancellationToken">A cancellation token.</param>
    /// <returns>The operation invocation result.</returns>
    ValueTask<KnOwlOperationResult<TResult>> ExecuteAsync<TRequest, TResult>(
        TRequest request,
        CancellationToken cancellationToken = default);
