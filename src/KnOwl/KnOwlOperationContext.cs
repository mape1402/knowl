...
/// <summary>
/// Provides services and inbox state to a KnOwl operation.
/// </summary>
public sealed class KnOwlOperationContext
{
    /// <summary>
    /// Initializes a new instance of the <see cref="KnOwlOperationContext"/> class.
    /// </summary>
    public KnOwlOperationContext(IServiceProvider services, IInboxService inbox, InboxContext inboxContext)
    {
