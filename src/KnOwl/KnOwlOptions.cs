...
/// <summary>
/// Configures the default behavior used by the KnOwl inbox core.
/// </summary>
public sealed class KnOwlOptions
{
    /// <summary>
    ...
    /// <summary>
    /// Gets the assemblies scanned for declared KnOwl operations.
    /// </summary>
    ...
    public KnOwlOptions ScanAssembly(Assembly assembly)
    {
    ...
    /// <returns>The same options instance for fluent configuration.</returns>
    public KnOwlOptions ScanAssemblyContaining<TMarker>()
