...
public sealed class DefaultInbox : IInboxService
{
    ...
    private readonly KnOwlOptions _options;
    ...
    public async ValueTask<InboxOpenResult> OpenOrContinueAsync(InboxOpenRequest request, CancellationToken cancellationToken = default)
    {
        ...
        if (result.State == InboxOpenState.Opened)
        {
            ...
            await PublishEventAsync(KnOwlEventNames.InboxOpened, result.Entry, cancellationToken);
            await PublishEventAsync(KnOwlEventNames.InboxAccepted, result.Entry, cancellationToken);
        ...
        if (result.Entry is not null)
        {
            ...
            await PublishEventAsync(KnOwlEventNames.InboxDuplicated, result.Entry, cancellationToken);
        }
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        await PublishEventAsync(KnOwlEventNames.InboxCompleted, context.Entry, cancellationToken);
        RestorePreviousContext(context);
    }
    ...
    public async ValueTask FailCurrentAsync(InboxFailure failure, CancellationToken cancellationToken = default)
    {
        ...
        await PublishEventAsync(KnOwlEventNames.InboxFailed, context.Entry, cancellationToken);
        RestorePreviousContext(context);
    }
